% Reads two outputs of 'Glafic' in 'fits' format and plots their residual
% have convolve2.m in the same directory

%%%%%%%%%%%%%%%%%%%%%%%
%% initialization
%%%%%%%%%%%%%%%%%%%%%%%
clear all
maindir = '/scratch/hathor/saas9842/1_proj/Sersic14/';
outputdir = [maindir,'out/'];
plotdir = [maindir,'plot/'];

res		    = 0.005;  	% native resolution in 'arcsec'. shoud match the one used in Glafic input file (should match the Glafic input file)
...
%     toc 
     ...
     F200_data = importdata('F200d.txt');
...
%     toc 
    ...
    F444_data = importdata('F444d.txt');
